...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00601();
...
*/
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C01952();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C00601 implements ThreadFactory {
    ...
    class C01952 extends WorkerRunnable<Params, Result> {
        C01952() {
        }
