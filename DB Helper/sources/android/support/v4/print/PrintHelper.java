...
*/
        ...
        public void printBitmap(String str, Uri uri, OnPrintFinishCallback onPrintFinishCallback) throws FileNotFoundException {
            ...
            final Uri uri2 = uri;
            final OnPrintFinishCallback onPrintFinishCallback2 = onPrintFinishCallback;
            PrintDocumentAdapter c00743 = new PrintDocumentAdapter() {
                private PrintAttributes mAttributes;
                Bitmap mBitmap = null;
                ...
                public void onLayout(PrintAttributes printAttributes, PrintAttributes printAttributes2, CancellationSignal cancellationSignal, LayoutResultCallback layoutResultCallback, Bundle bundle) {
                    ...
                    if (cancellationSignal.isCanceled() != null) {
                        ...
                        this.mLoadBitmap = new AsyncTask<Uri, Boolean, Bitmap>() {
                            ...
                            class C00721 implements OnCancelListener {
                                C00721() {
                                }

                                public void onCancel() {
                                    C00743.this.cancelLoad();
                                    C00731.this.cancel(false);
                                }
                            }

                            protected void onPreExecute() {
                                cancellationSignal2.setOnCancelListener(new C00721());
                            }
...
*/
                                /*
                                r1 = this;
                                r2 = android.support.v4.print.PrintHelper.PrintHelperApi19.C00743.this;	 Catch:{ FileNotFoundException -> 0x000d }
                                r2 = android.support.v4.print.PrintHelper.PrintHelperApi19.this;	 Catch:{ FileNotFoundException -> 0x000d }
                                r0 = android.support.v4.print.PrintHelper.PrintHelperApi19.C00743.this;	 Catch:{ FileNotFoundException -> 0x000d }
                            ...
                            protected void onPostExecute(Bitmap bitmap) {
                                ...
                                if (bitmap != null && (!PrintHelperApi19.this.mPrintActivityRespectsOrientation || PrintHelperApi19.this.mOrientation == 0)) {
                                    MediaSize mediaSize;
                                    synchronized (this) {
                                        mediaSize = C00743.this.mAttributes.getMediaSize();
                                    }
            ...
            if (this.mOrientation != 1) {
                if (this.mOrientation != 0) {
                    ...
                    printManager.print(str, c00743, onPrintFinishCallback.build());
                }
            }
