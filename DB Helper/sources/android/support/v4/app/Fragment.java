...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner {
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C00341 implements Creator<SavedState> {
            C00341() {
            }
    ...
    class C01922 extends FragmentContainer {
        C01922() {
        }
...
*/
        ...
        if (this.mFragmentManager != null) {
            if (this.mFragmentManager.mHost != null) {
                if (Looper.myLooper() != this.mFragmentManager.mHost.getHandler().getLooper()) {
                    this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C00331());
                    return;
                } else {
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C01922(), this);
    }
