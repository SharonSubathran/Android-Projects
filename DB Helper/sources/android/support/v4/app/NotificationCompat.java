...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (VERSION.SDK_INT >= 16 && VERSION.SDK_INT < 21) {
                if (i != 0) {
                    remoteViews.setInt(C0010R.id.notification_background, "setBackgroundResource", C0010R.drawable.notification_bg_low);
                    remoteViews.setInt(C0010R.id.icon, "setBackgroundResource", C0010R.drawable.notification_template_icon_low_bg);
                } else {
                    remoteViews.setInt(C0010R.id.notification_background, "setBackgroundResource", C0010R.drawable.notification_bg);
                    remoteViews.setInt(C0010R.id.icon, "setBackgroundResource", C0010R.drawable.notification_template_icon_bg);
                }
            }
            int i2 = 8;
            if (this.mBuilder.mLargeIcon != 0) {
                if (VERSION.SDK_INT >= 16) {
                    remoteViews.setViewVisibility(C0010R.id.icon, 0);
                    remoteViews.setImageViewBitmap(C0010R.id.icon, this.mBuilder.mLargeIcon);
                } else {
                    remoteViews.setViewVisibility(C0010R.id.icon, 8);
                }
                if (z && this.mBuilder.mNotification.icon) {
                    z = resources.getDimensionPixelSize(C0010R.dimen.notification_right_icon_size);
                    i = z - (resources.getDimensionPixelSize(C0010R.dimen.notification_small_icon_background_padding) * 2);
                    if (VERSION.SDK_INT >= 21) {
                        remoteViews.setImageViewBitmap(C0010R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, z, i, this.mBuilder.getColor()));
                    } else {
                        remoteViews.setImageViewBitmap(C0010R.id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    remoteViews.setViewVisibility(C0010R.id.right_icon, 0);
                }
            } else if (z && this.mBuilder.mNotification.icon) {
                remoteViews.setViewVisibility(C0010R.id.icon, 0);
                if (VERSION.SDK_INT >= true) {
                    remoteViews.setImageViewBitmap(C0010R.id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C0010R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0010R.dimen.notification_big_circle_margin), resources.getDimensionPixelSize(C0010R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                } else {
                    remoteViews.setImageViewBitmap(C0010R.id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle) {
                remoteViews.setTextViewText(C0010R.id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText) {
                remoteViews.setTextViewText(C0010R.id.text, this.mBuilder.mContentText);
                z = true;
            } else {
                z = false;
            }
            ...
            if (this.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C0010R.id.info, this.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C0010R.id.info, 0);
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > resources.getInteger(C0010R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0010R.id.info, resources.getString(C0010R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0010R.id.info, NumberFormat.getIntegerInstance().format((long) this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0010R.id.info, 0);
            } else {
                remoteViews.setViewVisibility(C0010R.id.info, 8);
                if (this.mBuilder.mSubText != null && VERSION.SDK_INT >= 16) {
                    remoteViews.setTextViewText(C0010R.id.text, this.mBuilder.mSubText);
                    if (this.mBuilder.mContentText == null) {
                        remoteViews.setTextViewText(C0010R.id.text2, this.mBuilder.mContentText);
                        remoteViews.setViewVisibility(C0010R.id.text2, 0);
                        z3 = true;
                        if (z3 && VERSION.SDK_INT >= 16) {
                            if (z2) {
                                remoteViews.setTextViewTextSize(C0010R.id.text, 0, (float) resources.getDimensionPixelSize(C0010R.dimen.notification_subtext_size));
                            }
                            remoteViews.setViewPadding(C0010R.id.line1, 0, 0, 0, 0);
                        }
                        if (this.mBuilder.getWhenIfShowing() != 0) {
                            if (this.mBuilder.mUseChronometer != 0 || VERSION.SDK_INT < 16) {
                                remoteViews.setViewVisibility(C0010R.id.time, 0);
                                remoteViews.setLong(C0010R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                            } else {
                                remoteViews.setViewVisibility(C0010R.id.chronometer, 0);
                                remoteViews.setLong(C0010R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                                remoteViews.setBoolean(C0010R.id.chronometer, "setStarted", true);
                            }
                            i = 1;
                        }
                        remoteViews.setViewVisibility(C0010R.id.right_side, i == 0 ? 0 : 8);
                        i = C0010R.id.line3;
                        if (z) {
                            i2 = 0;
                        }
                    ...
                    remoteViews.setViewVisibility(C0010R.id.text2, 8);
                }
                z3 = false;
                if (z2) {
                    remoteViews.setTextViewTextSize(C0010R.id.text, 0, (float) resources.getDimensionPixelSize(C0010R.dimen.notification_subtext_size));
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0010R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0010R.id.notification_main_column);
            remoteViews.addView(C0010R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0010R.id.notification_main_column, 0);
            if (VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0010R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0010R.id.title, 8);
            remoteViews.setViewVisibility(C0010R.id.text2, 8);
            remoteViews.setViewVisibility(C0010R.id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0010R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0010R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            boolean z2 = true;
            int i = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0010R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0010R.id.actions);
            if (z && this.mBuilder.mActions) {
                z = Math.min(this.mBuilder.mActions.size(), 3);
                if (z <= false) {
                    for (boolean z3 = false; z3 < z; z3++) {
                        applyStandardTemplate.addView(C0010R.id.actions, generateActionButton((Action) this.mBuilder.mActions.get(z3)));
                    }
                    if (z2) {
                        i = 8;
                    }
                    applyStandardTemplate.setViewVisibility(C0010R.id.actions, i);
                    applyStandardTemplate.setViewVisibility(C0010R.id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), obj != null ? C0010R.layout.notification_action_tombstone : C0010R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0010R.id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0010R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0010R.id.action_text, action.title);
            if (obj == null) {
                remoteViews.setOnClickPendingIntent(C0010R.id.action_container, action.actionIntent);
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0010R.id.action_container, action.title);
            }
            return remoteViews;
        }
    }
...
Error: java.lang.NullPointerException
	...
	at jadx.api.JadxDecompiler$$Lambda$8/48914743.run(Unknown Source)
*/
                /*
                r0 = 0;
