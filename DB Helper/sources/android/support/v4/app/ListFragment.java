...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00582();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00571();
    ...
    class C00582 implements OnItemClickListener {
        C00582() {
        }
