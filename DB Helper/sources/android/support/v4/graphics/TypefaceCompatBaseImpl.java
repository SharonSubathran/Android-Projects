...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C01961 implements StyleExtractor<FontInfo> {
        C01961() {
        }
    ...
    class C01972 implements StyleExtractor<FontFileResourceEntry> {
        C01972() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fontInfoArr, int i) {
        return (FontInfo) findBestFont(fontInfoArr, i, new C01961());
    }
...
*/
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, int i) {
        return (FontFileResourceEntry) findBestFont(fontFamilyFilesResourceEntry.getEntries(), i, new C01972());
    }
