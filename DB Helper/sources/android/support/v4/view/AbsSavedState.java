...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = new C00932();
    public static final AbsSavedState EMPTY_STATE = new C02021();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$2 */
    static class C00932 implements ClassLoaderCreator<AbsSavedState> {
        C00932() {
        }
    ...
    static class C02021 extends AbsSavedState {
        C02021() {
            super();
        }
    }
