...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01011();
    ...
    private static final Interpolator sInterpolator = new C01022();
    ...
    private final Runnable mEndScrollRunnable = new C01033();
    ...
    static class C01011 implements Comparator<ItemInfo> {
        C01011() {
        }
    ...
    static class C01022 implements Interpolator {
    ...
    class C02034 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C01041 implements ClassLoaderCreator<SavedState> {
            C01041() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02034());
    }
