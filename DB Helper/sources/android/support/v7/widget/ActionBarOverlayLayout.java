...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0142R.attr.actionBarSize, 16842841};
    ...
    class C01511 extends AnimatorListenerAdapter {
        C01511() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C01511();
        this.mRemoveActionBarHideOffset = new C01522();
        this.mAddActionBarHideOffset = new C01533();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0142R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0142R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0142R.id.action_bar));
        }
    }
