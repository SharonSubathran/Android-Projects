...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = -1;
            context = context.obtainStyledAttributes(attributeSet, C0142R.styleable.LinearLayoutCompat_Layout);
            this.weight = context.getFloat(C0142R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = context.getInt(C0142R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            context.recycle();
        }
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        context = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0142R.styleable.LinearLayoutCompat, i, 0);
        attributeSet = context.getInt(C0142R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (attributeSet >= null) {
            setOrientation(attributeSet);
        }
        attributeSet = context.getInt(C0142R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (attributeSet >= null) {
            setGravity(attributeSet);
        }
        attributeSet = context.getBoolean(C0142R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (attributeSet == null) {
            setBaselineAligned(attributeSet);
        }
        this.mWeightSum = context.getFloat(C0142R.styleable.LinearLayoutCompat_android_weightSum, -1082130432);
        this.mBaselineAlignedChildIndex = context.getInt(C0142R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = context.getBoolean(C0142R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(context.getDrawable(C0142R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = context.getInt(C0142R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = context.getDimensionPixelSize(C0142R.styleable.LinearLayoutCompat_dividerPadding, 0);
        context.recycle();
    }
            ...
            if (virtualChildAt.getVisibility() == 8) {
                ...
                if (f5 > 0.0f) {
                    ...
                    if (layoutParams2.height == 0) {
                        ...
                        if (i16 == 1073741824) {
                            ...
                            virtualChildAt.measure(i13, MeasureSpec.makeMeasureSpec(i29, 1073741824));
                            i17 = View.combineMeasuredStates(i17, virtualChildAt.getMeasuredState() & InputDeviceCompat.SOURCE_ANY);
                        }
                    } else {
                        i3 = 1073741824;
                    }
                    i29 = virtualChildAt.getMeasuredHeight() + i29;
                    if (i29 < 0) {
                        i29 = 0;
                    }
                ...
                if (mode != 1073741824) {
                    ...
                    if (layoutParams2.width == -1) {
                        ...
                        i13 = Math.max(i9, i13);
                        obj4 = (obj == null && layoutParams2.width == i12) ? 1 : null;
                        i3 = r7.mTotalLength;
    ...
    void measureHorizontal(int i, int i2) {
            ...
            if (virtualChildAt == null) {
                ...
                if (mode == i8 && layoutParams.width == 0 && layoutParams.weight > 0.0f) {
                    ...
                    if (z3) {
                        ...
                        i4 = (i18 == 0 && layoutParams.height == -1) ? 1 : 0;
                        if (layoutParams.weight <= 0.0f) {
                            if (i3 == 0) {
                                i8 = measuredHeight;
                            }
                    ...
                    int i21 = baseline;
                    view = virtualChildAt;
                    measureChildBeforeLayout(virtualChildAt, i19, i6, f2 == 0.0f ? r7.mTotalLength : 0, i7, 0);
                    i3 = i20;
                    ...
                    if (i9 != 0) {
                        ...
                        i10 = r7.mTotalLength;
                        r7.mTotalLength = Math.max(i10, (((i10 + i3) + layoutParams.leftMargin) + layoutParams.rightMargin) + getNextLocationOffset(view));
                    }
                    if (z) {
                        i11 = Math.max(i3, i11);
                    }
        ...
        if (z && (mode == Integer.MIN_VALUE || mode == 0)) {
            ...
            while (i10 < virtualChildCount) {
                ...
                if (virtualChildAt2 == null) {
                    ...
                    LayoutParams layoutParams2 = (LayoutParams) virtualChildAt2.getLayoutParams();
                    if (i9 != 0) {
                        r7.mTotalLength += ((layoutParams2.leftMargin + i11) + layoutParams2.rightMargin) + getNextLocationOffset(virtualChildAt2);
                    } else {
                        i6 = r7.mTotalLength;
                        i22 = i10;
                        r7.mTotalLength = Math.max(i6, (((i6 + i11) + layoutParams2.leftMargin) + layoutParams2.rightMargin) + getNextLocationOffset(virtualChildAt2));
                        i10 = i22 + 1;
                    }
                }
                i22 = i10;
        ...
        i10 = View.resolveSizeAndState(Math.max(r7.mTotalLength, getSuggestedMinimumWidth()), i, 0);
        baseline = (ViewCompat.MEASURED_SIZE_MASK & i10) - r7.mTotalLength;
        if (i13 == 0) {
            if (baseline == 0 || f <= 0.0f) {
                ...
                setMeasuredDimension(i10 | (ViewCompat.MEASURED_STATE_MASK & i4), View.resolveSizeAndState(Math.max(i3 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), baseline, i4 << 16));
                if (i17 != 0) {
            ...
            if (virtualChildAt4 != null) {
                if (virtualChildAt4.getVisibility() != 8) {
                    ...
                    if (f5 > 0.0f) {
                        ...
                        float f6 = f3 - f5;
                        int i24 = baseline - combineMeasuredStates;
                    ...
                    i8 = (mode2 == 1073741824 || layoutParams3.height != -1) ? 0 : 1;
                    ...
                    if (i18 != 0) {
                        ...
                        if (layoutParams3.height == -1) {
                            ...
                            if (z2) {
                                i11 = virtualChildAt4.getBaseline();
                                if (i11 != i5) {
                                    i6 = ((((layoutParams3.gravity >= 0 ? r7.mGravity : layoutParams3.gravity) & 112) >> 4) & -2) >> 1;
                                    iArr2[i6] = Math.max(iArr2[i6], i11);
                                    iArr[i6] = Math.max(iArr[i6], i7 - i11);
                                    i5 = i8;
