...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02251();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02262();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02113();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C02113 implements ViewPropertyAnimatorUpdateListener {
        C02113() {
        }
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0142R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0142R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0142R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0142R.id.action_bar_container);
            ...
            if (this.mContainerView != null) {
                ...
                if (!actionBarPolicy.enableHomeButtonByDefault()) {
                    if (view == null) {
                        ...
                        view = this.mContext.obtainStyledAttributes(null, C0142R.styleable.ActionBar, C0142R.attr.actionBarStyle, 0);
                        if (view.getBoolean(C0142R.styleable.ActionBar_hideOnContentScroll, false)) {
                            setHideOnContentScrollEnabled(true);
                        }
                        dimensionPixelSize = view.getDimensionPixelSize(C0142R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0142R.attr.actionBarWidgetTheme, typedValue, true);
